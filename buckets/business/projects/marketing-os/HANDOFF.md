...
- ⏭️ **Phase 0.3 (Persona + Avatares) — RETOMAR AQUÍ.** Hipótesis de avatares firmada en D-023 (ambos YA monetizan; eje = madurez del marketing online): **"Lanzador digital"** (vende local, marketing online ~cero) / **"Estancado"** (vende online, en meseta) — pasan 2-de-3. Siguiente trabajo: retrato del **persona primario** (pre-PMF ⇒ 1, spec §6) con método (Empathy Map, JTBD ≥1 funcional + 1 emocional, 5 dolores con fuente real) — Sandi hace el research y lo trae para esculpir juntos; se le pidió al operador evidencia de primera mano (clientes/comunidades reales) antes de arrancar. Arrastra: `negative_personas` (claims-incompatibles) + priorización de primer ciclo (las 2 decisiones humanas del spec).

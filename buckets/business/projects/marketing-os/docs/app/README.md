...
| `archive/pipeline-de-ideas.md` | **⚠️ SUPERSEDED (C17)** — describía las «~28 ideas / derivados 2.4» (modelo muerto). Hoy el pozo es **generativo** y `pieza = ángulo × canal` (autoridad: `../specs/spec_Superficies_Produccion.md`). |

...
| Phase 2 | 2.2 Canal×Momento | 🔄 DRAFT esperando validación | `channel_journey_matrix.json` — 4 canales DESDE where_we_meet firmado (seo_blog · comunidades_sellers value-first · email permission · paid_search SOLO-ventana deferred) + 3 no-usados con razón (YouTube V2 · RRSS-visual trampa-de-marco · LinkedIn B2B-parked) · advocacy deferred pre-PMF · carga ~4 acciones/sem |

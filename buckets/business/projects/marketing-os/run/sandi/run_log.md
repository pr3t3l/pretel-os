...
| Phase 1 | 1.4 Pricing + Naming + Statement | 🔄 TODO PROPUESTO — esperando FIRMA GLOBAL | `offer_spec.json` draft consolidado — pricing v2 (ancla cost_of_inaction con SUS fees) · language_pack firmado como estándar · **NOMBRE DEFINITIVO: PAPANDI (D-037)** — papandi.com/.ai libres, compra .com autorizada (handoff), historia familiar PRIVADA · `offer_statement_priya.md` DRAFT (EN, ~310 palabras) · `offer_spec.json` consolidado — **G-Phase-1 global espera la firma del operador** |

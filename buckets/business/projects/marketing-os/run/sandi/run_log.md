...
| Phase 1 | 1.2 Offer Stack | 🔄 DRAFT COMPLETO esperando tarjetas | `ai_cost_model.json` (Phase 0 = $1.06 MEDIDO; alcance D-034: texto sí, visuales no) · `offer_stack.json` — core "Plan de independencia del marketplace" $99 (comparable M1) + 4 bonuses con comparables (Ruta al primer dólar $97 · Medidor de independencia $49 · Borradores semanales $49 · Escuela en el camino $39); **ratio 11.1× ≥5 ✓ · margen 76% ≥70% ✓**; re-score likelihood 4→6 propuesto (pendiente 1.3) |

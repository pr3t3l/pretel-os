...
| Phase 1 | 1.3 Risk/Urgency/Displacement | 🔄 EN CURSO | `risk_urgency.json` draft — 4 decisiones del operador: garantía (A incondicional recomendada / B condicional), urgencia (A deadline-Q4 anclada a trigger #3 / B founders-price requiere compromiso / C none), escasez (none recomendado), displacement (texto propuesto, pieza obligatoria) |
| Phase 1 | 1.4 Pricing + Naming + Statement | ⏳ pendiente | pricing final + ratificar "Beats" + NAMING definitivo + statement ≤350 palabras |

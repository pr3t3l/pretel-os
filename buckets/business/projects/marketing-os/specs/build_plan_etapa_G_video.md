...
**Estado:** v1 — backlog **OUTPUT-side**. Se ejecuta DESPUÉS del rework del modelo de contenido (`build_plan_modelo_contenido.md`, P1-P5); **no lo bloquea**. Documentación aprobada por el operador 2026-07-06.

...
| 11 | **Costo de generación de IA** (imagen/video por endpoint) vs **lo que cobramos** al usuario | falta — el wrapper (`spec_AI_Gateway_Wrapper`) lo mide por llamada → este ledger; cruza con el pricing de producción (por pieza **ángulo × canal** — `spec_Production_Support_and_Pricing`; C17, ex «pricing del Estudio») (mandato 2026-06-28) |

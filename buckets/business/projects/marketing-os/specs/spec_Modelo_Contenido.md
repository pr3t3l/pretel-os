...
**Estado:** v1 — **FIRMADO 2026-07-06** (ratificado como C17 en `_audit_change_ledger.md`). Ejecución: `build_plan_modelo_contenido.md` (P1-P5) + `build_plan_etapa_G_video.md` (post-producción, output-side). **Vocabulario estándar aprobado:** DOLOR (el gancho) × FORMA (catálogo 4.550) × ESCENA (apertura visual) — DOLOR es base obligatoria; FORMA/ESCENA son opcionales y se componen.

...
2. **Knowledge in retrieval, not in the prompt (CAG→RAG).** The corpus exceeds useful context → pull the relevant slice just-in-time. CAG now (distilled essentials), RAG when triggers hit.
